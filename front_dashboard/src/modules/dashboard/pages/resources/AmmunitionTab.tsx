...
const AmmunitionTab: React.FC = () => {
  ...
  const handleSave = async (
    itemData: Omit<AmmunitionItem, 'id' | 'createdAt' | 'updatedAt'>,
    imageChanges?: PrimaryImageChanges,
  ) => {
    try {
      if (selectedAmmunition) {
        const newPrimaryMediaId = await applyPrimaryImageChanges({
          resourceId: selectedAmmunition.id,
          currentPrimaryMediaId: selectedAmmunition.primaryMediaId,
        ...
        const created = result.item as AmmunitionItem;
