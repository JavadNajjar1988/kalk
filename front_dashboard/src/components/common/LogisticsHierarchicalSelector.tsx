...
import { useLogisticsHierarchy, type LogisticsPath, type LogisticsFieldDefinition } from '@/hooks/useLogisticsHierarchy';

interface LogisticsHierarchicalSelectorProps {
  value?: LogisticsPath[];
...
const LogisticsHierarchicalSelector: React.FC<LogisticsHierarchicalSelectorProps> = ({
  value = [],
  onChange,
  onFieldsChange,
  error,
