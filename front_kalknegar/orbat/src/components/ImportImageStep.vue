  ...
  <div class="">
    <form @submit.prevent="onLoad" class="mt-4 flex max-h-[80vh] min-h-[25rem] flex-col">
      <div class="flex-auto overflow-auto p-0.5">
        ...
        <section class="mt-4">
          <InputGroup label="نام لایه تصویر" v-model="form.layerName" />
        </section>
      </div>
      <AlertWarning v-if="isBlob" title="هشدار"
        >این تصویر یک فایل محلی است و با سناریو ذخیره نخواهد شد. فقط تا زمانی که سناریو باز است قابل مشاهده خواهد بود.
      </AlertWarning>
