...
const layerMenuItems: MenuItemData<ScenarioLayerAction>[] = [
  { label: "بزرگ‌نمایی روی", action: ScenarioLayerActions.Zoom },
  { label: "بعنوان فعال تنظیم کن", action: ScenarioLayerActions.SetActive },
  { label: "ویرایش", action: ScenarioLayerActions.Edit },
  { label: "بردن بالا", action: ScenarioLayerActions.MoveUp },
  { label: "بردن پایین", action: ScenarioLayerActions.MoveDown },
  { label: "حذف", action: ScenarioLayerActions.Delete },
];
