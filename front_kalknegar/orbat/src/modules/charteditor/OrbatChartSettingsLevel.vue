<template>
  <div class="pb-4">
    <div class="flex items-center justify-between">
      <p class="text-sm text-gray-600">گزینه‌های خاص سطح.</p>
      <PlainButton :disabled="usedOptions.size === 0" @click="clearSpecificOptions()"
        >پاک کردن تنظیمات</PlainButton
      >
    </div>
    <div class="mt-4">
      <SimpleSelect label="سطح" :items="levelItems" v-model="test"></SimpleSelect>
      <AccordionPanel label="تنظیمات واحد" default-open>
        <SettingsUnit :item-type="ChartItemTypes.Level" />
      </AccordionPanel>
      <AccordionPanel label="چیدمان و فاصله‌گذاری">
        <NumberInputGroup
          label="فاصله سطح"
