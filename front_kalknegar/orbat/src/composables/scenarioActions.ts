...
export function useUnitMenu(
  ...
  const unitMenuItems = computed((): MenuItemData<UnitAction>[] => {
    return [
      ...
      { label: "حذف", action: UnitActions.Delete, disabled: isLocked.value },
      { label: "پاک کردن وضعیت", action: UnitActions.ClearState, disabled: isLocked.value },
      { label: "ویرایش", action: UnitActions.Edit, disabled: isLocked.value },
      {
        label: "باز کردن",
      ...
      { label: "تکرار", action: UnitActions.Clone, disabled: isLocked.value },
      {
        label: "تکرار (با وضعیت)",
        action: UnitActions.CloneWithState,
        disabled: isLocked.value,
      },
      {
        label: "تکرار سلسله مراتب",
        action: UnitActions.CloneWithSubordinates,
        disabled: isLocked.value,
      },
      {
        label: "تکرار سلسله مراتب (با وضعیت)",
        action: UnitActions.CloneWithSubordinatesAndState,
        disabled: isLocked.value,
      },
      { label: "حرکت به بالا", action: UnitActions.MoveUp, disabled: isLocked.value },
      { label: "حرکت به پایین", action: UnitActions.MoveDown, disabled: isLocked.value },
      unit.locked
        ? {
            label: "باز کردن قفل",
