...
import { parameterized } from '../../symbology/2525c.js'
import Signal from '@syncpoint/signal'
import * as Geometry from '../../model/geometry.js'
...
export default feature => {
  ...
  else if (geometryType === 'MultiPolygon') return polygon($)
  else if (geometryType === 'LineString') return linestring($)
  else if (geometryType === 'MultiLineString') return linestring($)
