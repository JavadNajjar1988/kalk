...
const STORAGE_PROJECTS = 'kalk:web:projects:v1'
const STORAGE_CREDENTIALS = id => `kalk:web:credentials:${id}`
const STORAGE_STREAM_TOKEN = id => `kalk:web:streamToken:${id}`
const STORAGE_SEED = id => `kalk:web:seed:${id}`
