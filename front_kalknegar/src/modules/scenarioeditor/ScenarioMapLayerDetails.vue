...
const tabList = computed(() =>
  uiStore.debugMode ? ["جزئیات", "تنظیمات", "اشکال‌زدایی"] : ["جزئیات", "تنظیمات"],
);
      ...
      <div class="flex">
        ...
        <div class="ml-2 flex shrink-0 items-center">
          <IconButton
            ...
            title="بزرگنمایی به محدوده لایه"
          >
            <ZoomIcon class="h-6 w-6" />
          </IconButton>
          <IconButton @click="toggleLayerVisibility()" title="تغییر قابلیت مشاهده">
