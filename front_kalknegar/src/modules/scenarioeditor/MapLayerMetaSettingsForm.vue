...
<template>
  <form @submit.prevent="updateData" class="p-1">
    <div class="space-y-4">
      <TextAreaGroup :id="focusId" label="توضیحات" v-model="formData.description" />
      <InputGroup
        :id="focusId"
        label="آدرس خارجی"
        type="text"
    ...
    <footer class="mt-4 flex justify-end space-x-2">
      <BaseButton small primary type="submit">بروزرسانی</BaseButton>
      <BaseButton small type="button" @click="emit('cancel')">لغو</BaseButton>
    </footer>
  </form>
</template>
