...
<template>
  <div class="col-span-2 -mb-2 font-semibold">خط</div>
  ...
  />
  <label for="stroke-width" class="">عرض</label>
  ...
  <label for="stroke-opacity">شفافیت</label>
  <div class="grid grid-cols-[1fr_5ch] gap-4">
    <Slider
      id="stroke-opacity"
      v-model="opacity"
  ...
  <label for="stroke-style" class="self-center">سبک</label>
  <div class="grid grid-cols-[1fr_5ch] gap-4">
    <NewSelect
      id="stroke-style"
      ...
      :items="[
        { label: 'پیوسته', value: 'solid' },
        { label: 'خط‌چین', value: 'dashed' },
        { label: 'نقطه‌ای', value: 'dotted' },
      ]"
    />
  </div>
</template>
