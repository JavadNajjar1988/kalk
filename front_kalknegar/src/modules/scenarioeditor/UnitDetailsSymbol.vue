...
const landUnitFields: TextFieldMeta[] = [
  { x: 3, y: 2, field: "G", title: "نظرات ستاد" },
  { x: 3, y: 3, field: "H", title: "اطلاعات اضافی" },
  { x: 1, y: 4, field: "T", title: "نام منحصربه‌فرد" },
  { x: 3, y: 4, field: "M", title: "تشکیل بالاتر" },
];

const surfaceFields: TextFieldMeta[] = [
  { x: 3, y: 1, field: "T", title: "نام منحصربه‌فرد" },
  { x: 3, y: 4, field: "G", title: "نظرات ستاد" },
];
...
<template>
  <section class="-mx-4 sm:mx-0">
    ...
    <p class="mt-2 text-sm leading-7 font-medium">پیش‌نمایش</p>
