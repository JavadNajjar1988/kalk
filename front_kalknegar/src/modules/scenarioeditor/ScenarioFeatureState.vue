...
const menuItems: MenuItemData<StateAction>[] = [{ label: "حذف", action: "delete" }];
...
<template>
  <div class="mt-4">
    <PanelSubHeading>وضعیت ویژگی</PanelSubHeading>

    <div class="flex justify-end">
      <BaseButton small @click="clearState()">پاک کردن وضعیت</BaseButton>
    </div>
