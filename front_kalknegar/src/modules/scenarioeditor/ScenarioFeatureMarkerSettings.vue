...
const markerItems: SelectItem<MarkerSymbol>[] = [
  ...
  { label: "ضربدر", value: "cross" },
  { label: "ششضلعی", value: "hexagon" },
  { label: "پنجضلعی", value: "pentagon" },
...
<template>
  <div class="col-span-2 -mb-2 font-semibold">نماد</div>
  <div class="self-center">رنگ</div>
  <PopoverColorPicker
    :model-value="marker['marker-color']"
    @update:model-value="updateValue('marker-color', $event)"
  />
  <div class="self-center">اندازه</div>
  <RadioGroup
    :model-value="marker['marker-size']"
    @update:model-value="updateValue('marker-size', $event)"
    class=""
  >
    <RadioGroupLabel class="sr-only">انتخاب اندازه نشانگر</RadioGroupLabel>
