  ...
  <div v-if="selectedItems.length" class="pb-2">
    ...
    <div class="mt-4 flex items-center justify-between">
      <Button
        ...
        ><PlusIcon />افزودن</Button
      >
      <InputCheckbox v-model="showPreview" label="نمایش پیش‌نمایش" />
    </div>
    <Tabs defaultValue="add" class="border-border mt-4 border-t pt-4">
      <TabsList class="w-full">
        <TabsTrigger value="add">ویژگی جدید</TabsTrigger>
        <TabsTrigger value="update">به‌روزرسانی موجود</TabsTrigger>
      </TabsList>
    ...
    <div class="mt-4 flex items-center justify-end">
      ...
      <TabsContent value="update">
        <Label class="mt-2 pb-1.5">انتخاب ویژگی</Label>
