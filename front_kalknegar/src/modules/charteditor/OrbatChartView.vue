<template>
  <div class="relative flex h-full w-screen overflow-hidden">
    ...
    <SlideOver v-model="isMenuOpen" left title="تنظیمات چیدمان نمودار">
    ...
    <main class="relative min-w-0 flex-auto print:block">
      ...
      <div class="absolute top-4 left-4 flex items-center space-x-4 print:hidden">
        ...
        <ToggleField v-model="debug">حالت اشکال‌زدایی</ToggleField>
        <ToggleField v-model="isInteractive">تعاملی</ToggleField>
...
const menuItems: MenuItemData<Function>[] = [
  { label: "دانلود SVG", action: doSVGDownload },
  { label: "دانلود PNG", action: doPNGDownload },
];
