...
const columns = ref<ColumnDef<ExtendedUnit, any>[]>([
  ...
  }),
  {
    header: "فراداده",
    columns: [
      columnHelper.accessor("name", { header: "نام" }),
      columnHelper.accessor("shortName", { header: "نام کوتاه" }),
      columnHelper.accessor("externalUrl", { header: "آدرس" }),
    ],
  },

  columnHelper.accessor("sideName", { header: "طرف" }),
  columnHelper.accessor("sideGroupName", { header: "گروه طرف" }),
...
const sideMenuItems: MenuItemData<SideAction>[] = [
  ...
  { label: "بردن بالا", action: SideActions.MoveUp },
  { label: "بردن پایین", action: SideActions.MoveDown },
];
...
<template>
  <main class="flex h-full flex-col">
    <div class="flex shrink-0 items-center gap-4 p-4">
      ...
      <InputGroup v-model="query" placeholder="جستجو" />
    </div>
    <section
