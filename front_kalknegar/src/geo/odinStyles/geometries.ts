...
import { DEG2RAD, RAD2DEG, PI_OVER_2 } from './Math'


/**
 * rectangleProperties :: JTS/Geometry -> {k: v}
 */
export const rectangleProperties = (geometry: any) => {
...
export const circleProperties = (geometry: any) => {
  const coordinates = TS.coordinates(geometry)
  const segment01 = TS.segment(coordinates[0], coordinates[1])
...
export const corridorProperties = (geometry: any) => {
 ...
 */
export const rectangle = (geometry: any, { am, am1, an }: any) => {
...
export const corridor = (geometry: any, { am, am1 }: any) => {
 ...
 */
export const circle = (geometry: any, { am, an }: any) => {
