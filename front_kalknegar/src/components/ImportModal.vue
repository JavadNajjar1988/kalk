...
const ImportBaseMapUrlStep = defineAsyncComponent(
  () => import("@/components/ImportBaseMapUrlStep.vue"),
);
  ...
  >
    <div class="overflow-x-hidden">
      ...
      <ImportKMLStep
        ...
        @loaded="onImport"
      />
      <ImportBaseMapUrlStep
        v-else-if="importState === 'basemap'"
        @cancel="onCancel"
        @loaded="onImport"
      />
