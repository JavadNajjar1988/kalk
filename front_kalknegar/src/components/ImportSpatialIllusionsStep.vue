    ...
    <form @submit.prevent="onLoad" class="mt-4 flex max-h-[80vh] min-h-[25rem] flex-col">
      <div class="flex-auto overflow-auto">
        ...
        <section class="mt-4 flex gap-4 p-1">
          <InputCheckbox v-model="useFillColor" label="استفاده از رنگ پر سفارشی" />
          <InputCheckbox v-model="expandedStackedUnits" label="گسترش واحدهای انباشته" />
        </section>
      </div>
